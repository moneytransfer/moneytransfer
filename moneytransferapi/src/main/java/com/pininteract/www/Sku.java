...
public class Sku  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.pininteract.com", "Sku"));
        ...
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.pininteract.com", ">Sku>internationalCodes"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
