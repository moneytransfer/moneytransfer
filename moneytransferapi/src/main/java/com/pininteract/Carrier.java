...
public class Carrier  implements java.io.Serializable {
    private com.pininteract.Sku[] skus;
     ...
     * @return skus
     */
    public com.pininteract.Sku[] getSkus() {
        return skus;
    }
     ...
     * @param skus
     */
    public void setSkus(com.pininteract.Sku[] skus) {
        this.skus = skus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:pininteract.com", "Carrier"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:pininteract.com", "skus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:pininteract.com", "Sku"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:pininteract.com", "sku"));
